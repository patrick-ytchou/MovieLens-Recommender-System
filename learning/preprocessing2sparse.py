...
def create_sparse_data(df, filepath):
    """
...
if __name__ == '__main__':
    ...
    print("Now: Create sparse matrix for training data.")
    create_sparse_data(df_train, 'data/Atrain.npz')
    print("Now: Create sparse matrix for testing data.")
    create_sparse_data(df_test, 'data/Atest.npz')